...
\author{\textit{[Author name and affiliation removed for double-blind peer review]}}
...
\begin{abstract}
\noindent
Generative AI (GenAI) coding assistants have diffused rapidly across
the global north, but evidence for lower- and middle-income countries
remains sparse. Bangladesh, with 1.5 million software practitioners
and USD 1.9 billion in IT exports, offers an informative case
relevant to SDG~8 and SDG~9. This paper presents the first integrated
quantitative analysis of GenAI adoption in the Bangladeshi software
engineering sector for 2022--2026. The analysis combines a Bass
diffusion model, a synthetic workforce simulation ($N=1{,}500$)
calibrated to BASIS, BBS, and World Bank statistics, and a
heterogeneity-aware battery including treatment effect estimation by
English proficiency stratum and a skills gap index by university
tier. Adoption follows a steep S-curve ($\hat{p}=0.026$,
$\hat{q}=0.36$, $\hat{m}=0.86$); multinational subsidiaries lead at
75 per cent while local SMEs lag at 54 per cent. The productivity
differential is large (Cohen's $d=1.71$); English proficiency is a
robust moderator (effects rise from $d=1.27$ at CEFR~A2 to $d=2.00$
at C1); and skills gaps are largest at Tier~3 private universities. A
combined digital literacy and mentorship scenario raises projected
2031 adoption from 83 to 96 per cent, adding 260{,}000 adopters.
...
figures and 11 data tables are released openly under the MIT licence
for code and CC BY 4.0 for the paper [URL withheld for blind review].
...
All source code, automated unit tests, figures and data tables are
released openly under the MIT licence for code and CC~BY~4.0 for the
paper. The fixed random seed is \texttt{SEED=20260524}.
\textit{[Repository URL withheld for blind review.]}
...
\textit{[Acknowledgements removed for double-blind peer review.]}
