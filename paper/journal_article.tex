...
diffused rapidly across the global north, but comparable evidence for
lower- and middle-income countries remains sparse. Bangladesh, with
approximately 1.5 million software practitioners and USD 1.9 billion
in IT export revenues, offers an informative case directly relevant
to SDG~8 and SDG~9. This paper presents the first integrated
...
diffusion model, a reproducible synthetic workforce simulation
($N=1{,}500$) anchored to BASIS, BBS, and World Bank statistics, and
a heterogeneity-aware statistical battery including treatment effect
estimation by English proficiency stratum and a skills gap index by
university tier. Adoption follows a steep S-curve ($\hat{p}=0.026$,
$\hat{q}=0.36$, $\hat{m}=0.86$); multinational subsidiaries lead at
75 per cent while local SMEs lag at 54 per cent. The unadjusted
productivity differential is large (Cohen's $d=1.71$); English
proficiency is a robust moderator (effects rise from $d=1.27$ at
CEFR~A2 to $d=2.00$ at C1); and skills gaps are largest at Tier~3
private universities. A combined digital literacy and mentorship
scenario raises projected 2031 adoption from 83 to 96 per cent,
adding approximately 260{,}000 adopters.
